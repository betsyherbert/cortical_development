...
class NeuralLayer:
    ...
    def __init__(
        self, grid_size: int = GRID_SIZE, dt: float = DT, time_constants: dict[str, float] = None
    ):
        """
        ...
        self.gain = {"E": 1.0, "SST": 1.0, "PV": 1.0}
...
class CorticalCircuit:
    ...
    def get_layer_activities(self) -> dict[str, dict[str, np.ndarray]]:
        ...
        """
        activities = {layer_name: self.layers[layer_name].r.copy() for layer_name in LAYERS}
