...
class DescriptiveAnalysis:
    ...
    def calculate_dimensionality(self, processed_data: dict[str, Any]) -> dict[str, Any]:
        ...
        total_dim = self._calculate_participation_ratio(all_cells)
        ...
        for cell_type in CELL_TYPES:
            ...
            if len(cell_indices) > 1:
                ...
                dim_by_celltype[cell_type] = self._calculate_participation_ratio(celltype_data)
            else:
        ...
        for layer in LAYERS:
            ...
            if len(layer_indices) > 1:
                ...
                dim_by_layer[layer] = self._calculate_participation_ratio(layer_data)
            else:
