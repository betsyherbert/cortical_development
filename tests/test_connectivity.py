...
def test_connectivity_profile_weight_matrix(grid_size):
    ...
    weight_matrix = profile.compute_weight_matrix(amplitude, sigma_um, source_size, target_size)
...
def test_spatial_scale_conversion():
    ...
    from src.model.config import get_grid_scale, grid_to_um, um_to_grid
